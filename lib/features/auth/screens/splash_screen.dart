            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: const Color(0xFF4CAF50).withValues(alpha: 0.3), blurRadius: 20, offset: const Offset(0, 8)),
                  ],
              ...
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  strokeWidth: 2, color: const Color(0xFF4CAF50).withValues(alpha: 0.6),
                ),
              ),
            ],
          ),
